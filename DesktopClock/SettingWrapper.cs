...
namespace DesktopClock
{
    public class SettingWrapper : ISettingWrapper
    {
        ...
        public VerticalAlignment VerticalAlignment { get => _Settings.VerticalAlignment; set => _Settings.VerticalAlignment = value; }
        public HorizontalAlignment HorizontalAlignment { get => _Settings.HorizontalAlignment; set => _Settings.HorizontalAlignment = value; }
